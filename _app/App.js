...
const DeleteSelectedGraphsCmd = require('./commands/DeleteSelectedGraphsCmd');
const DnDAddNotesToGraphCmd = require('./commands/DnDAddNotesToGraphCmd');
const AddSelectedNotesToGraphCmd = require('./commands/AddSelectedNotesToGraphCmd');
const NewNoteFromGraphCmd = require('./commands/NewNoteFromGraphCmd');
const DeleteVertexFromGraphCmd = require('./commands/DeleteVertexFromGraphCmd');
const NewEdgeGraphCmd = require('./commands/NewEdgeGraphCmd');
const DeleteEdgeFromGraphCmd = require('./commands/DeleteEdgeFromGraphCmd');
